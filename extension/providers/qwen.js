...
const ZSProvider = (() => {
  ...
  // Scope to the site's composer only; skip Multi-Script's own injected textarea
  ...
  function truncateForSend(text) {
    ...
    const marker =
      `\n\n[…Multi-Script: result truncated to fit Qwen's ${SEND_CAP}-character input ` +
  ...
  // tool-calls instead of Multi-Script commands. Removed 2026-07: the real cause of
