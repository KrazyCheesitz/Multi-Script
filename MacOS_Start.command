...
# MacOS_Start.command
# ---------------------------------------------------------------------------
#  Self-contained macOS/Linux launcher for the Multi-Script bridge.
...
if [ ! -f "runtime/bridge.py" ]; then
    echo "  ERROR: runtime/bridge.py was not found."
...
echo "  ############################################################"
echo
log "Launching runtime/bridge.py with $PY"

"$PY" runtime/bridge.py
BRIDGE_EXIT=$?
log "runtime/bridge.py exited with code $BRIDGE_EXIT"
